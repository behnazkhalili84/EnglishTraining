...
class GrammarQuiz: Fragment() {
    ...
    override fun onCreateView(
        ...
        val view = inflater.inflate(R.layout.fragment_grammar_quiz, container, false)
        setupUI(view)
        setupObservers()
        setupListeners()
    ...
    private fun onOptionSelected(option: Int) {
        if (!isAnswerSubmitted) {
            ...
            Log.d("GrammarQuiz", "Option Selected: $option")
        ...
        if (!isAnswerSubmitted) {
            if (selectedOptionPosition == 0) {
                ...
                if (question != null && selectedOptionPosition == question.correctAnswer) {
                    Log.d("GrammarQuiz", "Correct answer selected")
